...
mod tests {
    ...
    fn test_parse_basic_paf_line() {
        ...
        assert_eq!(anchor.query_name, "query1");
        assert_eq!(anchor.query_length, 1000);
        assert_eq!(anchor.query_start, 100);
        assert_eq!(anchor.query_end, 900);
        assert_eq!(anchor.strand, Strand::Forward);
        assert_eq!(anchor.target_name, "target1");
        assert_eq!(anchor.target_length, 2000);
        assert_eq!(anchor.target_start, 500);
        assert_eq!(anchor.target_end, 1300);
        assert_eq!(anchor.residue_matches, 750);
        assert_eq!(anchor.alignment_block_length, 800);
        assert_eq!(anchor.mapping_quality, Some(60));
    ...
    fn test_parse_no_mapping_quality() {
        ...
        let anchor = PafParser::parse_line(line).unwrap();
        assert_eq!(anchor.mapping_quality, None);
    }
    ...
    fn test_parse_reader() {
        ...
        assert_eq!(anchors[0].query_name, "query1");
        assert_eq!(anchors[1].query_name, "query2");
    ...
    fn test_iterator() {
        ...
        assert_eq!(first.query_name, "query1");
        
        let second = iterator.next().unwrap().unwrap();
        assert_eq!(second.query_name, "query2");
